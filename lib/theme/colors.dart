...
final lightFillColor = Colors.black;
final darkFillColor = Colors.white;

final whiteColor = Colors.white;
final darkColor = Color(0xFF202125);
...
final appriseLightBackground = Color(0xFFF5F5F5); // grey[100]
final appriseLightOnBackground = Colors.black;

// final appriseLightSurface = Colors.white;
final appriseLightSurface = Color(0xFFF5F5F5); // grey[100]
final appriseLightOnSurface = Colors.black;

final appriseLightError = Colors.red;
final appriseLightOnError = Colors.black;
...
// final appriseDarkBackground = Color(0xFF202125);
final appriseDarkOnBackground = Colors.white;

// final appriseDarkSurface = Color(0xFF212121); // grey[900]
final appriseDarkSurface = Color(0xFF202125); // sample
final appriseDarkOnSurface = Colors.white;

final appriseDarkError = Colors.red;
